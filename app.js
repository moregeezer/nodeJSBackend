...
app.post('/users', function (req, res) {
    ...
    var query = "INSERT INTO users (nome, cognome) VALUES (?,?);";
    console.log(query);
    connection.query(query, [req.body.nome, (req.body.cognome) ? 1 : 0, req.params.id], function (err, result) {
        if (err)
            throw err;
...
app.put('/users/:id', function (req, res) {
    ...
    var query = "UPDATE todos SET nome = ?, ruolo = ? WHERE id = ?;";
    console.log(query);
    connection.query(query, [req.body.nome, (req.body.ruolo) ? 1 : 0, req.params.id], function (err, result) {
        if (err)
            throw err;
...
console.log('Connecting to HANA db...');
connection.connect();
